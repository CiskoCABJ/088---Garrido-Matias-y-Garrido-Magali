...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-10-2021 a las 04:40:51
...
(18, 'The Starling', 'Tras sufrir una pérdida, una mujer se las tiene que ver con un pájaro peleón que se ha apoderado de su jardín… y un marido que no encuentra la forma de seguir adelante.', 103, 'Chris ODowd, Daveed Diggs, Don McManus, Edi Patterson.', 'img/thestarling.jpg', 'Accion', 2021),
